...
class GamePage extends Page {
    ...
    public get gameTimeoutBtn() {
        return '//*[@id="root"]/div/div[2]/div[5]/div[1]'
    }
    /**
    * define selectors using getter methods
    */
    ...
    */
    public get gameHomeTeamCallTimeout() {
        return '//*[@id="root"]/div/div[2]/div[6]/div/div[1]/span'
    }
    /**
    * define selectors using getter methods
    */
    ...
    */
    public get gameAwayTeamCallTimeout() {
        return '//*[@id="root"]/div/div[2]/div[6]/div/div[3]/span'
    }
    /**
    * define selectors using getter methods
    */
    ...
    */
    public get gameFullTimeout() {
        return '//*[@id="root"]/div/div[2]/div[6]/div/div[2]/div[1]'
    }
    /**
    * define selectors using getter methods
    */
    ...
    */
    public get gameOfficialTimeout() {
        return '//*[@id="root"]/div/div[2]/div[6]/div/div[2]'
   ...
   */
    public get gameMedia() {
        return '//*[@id="root"]/div/div[2]/div[6]/div/div[2]/div[3]'

    }
    /**
   * define selectors using getter methods
   */
    public get timeoutDetailsCommercial() {
        return '//*[@id="root"]/div/div[2]/div[6]/div/div[2]/div[3]'
    ...
    */
    ...
    public get gameMandatoryCheckbox() {
        return '//*[@id="root"]/div/div[2]/div[6]/div/div[3]/div[2]/i'
    ...
    */
    public get gameTimeoutOkBtn() {
        return '//*[@id="root"]/div/div[2]/div[6]/div/div[4]'
    ...
    */
    ...
    public get homeTeamSubstitutionBtns() {
        return '//*[@id="root"]/div[1]/div[2]/div[4]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div'
    }
    /**
     * define selectors using getter methods
     */
    public get awayTeamSubstitutionBtns() {
        return '//*[@id="root"]/div[1]/div[2]/div[4]/div[2]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div'
    }
    /**
     * define selectors using getter methods
     */
     ...
     * define selectors using getter methods
     */
    // public get freethrowsDoneBtn() {
    //     return '[class="match-button action enabled-true"]'
    //     
    // }

    /**
    * a method to encapsule automation code to interact with the page
    * e.g. function made2Points score two points
    */
    ...
    */
    public async miss3Points(side: string, shotType: string, playerRebounded: string, teamRebounded: string, block: string, blockSide: string, blockPlayer: string, clockShotValidation: string, cancel: boolean) {
        ...
        if (side.toLowerCase() == "home") {
            ...
            const coordinateY = await HelperPage.generateRandomNumberRange(10, 180)
            await $(await this.courtMap).click({ x: -coordinateX, y: -coordinateY })
            await HelperPage.waitUntilElement(this.homeTeamMiss3PointsBtn, 60000)
            await $(await this.homeTeamMiss3PointsBtn).click()
            ...
            await HelperPage.waitUntilElement(this.awayTeamMiss3PointsBtn, 60000)
            await $(await this.awayTeamMiss3PointsBtn).click()
    ...
    */
    public async makeTurnover(side: string, commitedTurnover: string, turnoverType: string, steal: string) {
        ...
        if (side.toLocaleLowerCase() == 'home') {
            ...
            await $(await this.courtMap).click({ x: -coordinateX, y: -coordinateY })
            await HelperPage.waitUntilElement(this.homeTeamTurnoverBtn, 60000)
            await $(await this.homeTeamTurnoverBtn).click()
        }
        else {
            const coordinateX = await HelperPage.generateRandomNumberRange(20, 220)
            const coordinateY = await HelperPage.generateRandomNumberRange(20, 180)
            await $(await this.courtMap).click({ x: coordinateX, y: -coordinateY })
            await HelperPage.waitUntilElement(this.awayTeamTurnoverBtn, 60000)
            await $(await this.awayTeamTurnoverBtn).click()
        }
        ...
        if (commitedTurnover.toLocaleLowerCase() == 'player') {
            ...
            let turnoverTypeBtn = '//*//div[2]/div[6]/div/div[2]/div[contains(text(), "' + turnoverType + '")]'
    ...
    */
    public async jumpBall(jumpBallType: string) {
    ...
    */
    public async changeSemaphoreTime(up: string, upMinutes: number, upSeconds: number, down: string, downMinutes: number, downSeconds: number) {
        ...
        const minutesArrowUpBtn = '//*[@id="root"]/div/div[2]/div[2]/div[3]/i[1]'
        const minutesArrowDownBtn = '//*[@id="root"]/div/div[2]/div[2]/div[3]/i[2]'
        const secondsArrowUpBtn = '//*[@id="root"]/div/div[2]/div[2]/div[4]/i[1]'
        const secondsArrowDownBtn = '//*[@id="root"]/div/div[2]/div[2]/div[4]/i[1]'

        // let periodTime = await this.getDisplayedTime()
        // let minutes = periodTime.minutes - (upMinutes || downMinutes)
        // let seconds = periodTime.seconds - (upSeconds || downSeconds)
        console.log("test")
