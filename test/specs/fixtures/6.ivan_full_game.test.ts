...
describe('Full game', () => {
    ...
    it('This test should populate full game', async () => {
        ...
        //CANCEL FREETHROWS
        await GamePage.makeFoul(game.home, game.home, game.inBox, game.player, game.unsportsmanlike, 3, game.made, game.player, null, 'cancel')

        //CANCEL FREETHROWS
        await GamePage.makeFoul(game.away, game.away, game.inBox, game.player, game.unsportsmanlike, 2, game.made, game.player, null, 'cancel')
        ...
        //CANCEL MADE 2
        await GamePage.made2Points(game.away, game.inBox, game.jumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakTrue, game.defensiveTrue, null, true)
        ...
        //CANCEL MADE 3
        await GamePage.made3Points(game.home, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveFalse, null, true)
        ...
        //MAKE SUBSTITUTION BEFORE TWO FREETHROWS
        await GamePage.makeFoul(game.away, game.home, game.outBox, game.player, game.technicalFoul, 3, game.made, game.player, null, 'make substitution')
        ...
        await GamePage.makeFoul(game.home, game.home, game.inBox, game.coach, null, 2, game.miss, game.player, game.coachTechnical, 'no substitution')
        await browser.pause(1000)
        await $(await GamePage.startPeriodBtn).click()
        await browser.pause(1000)
        await $(await GamePage.editCheckedStartTimePencil).click()
        ...
        await browser.pause(1000)
        await $(await GamePage.stopMatchBtn).click()
        await GamePage.makeFoul(game.home, game.home, game.inBox, game.bench, null, 1, game.made, null, null, 'no substitution')
        await browser.pause(1000)
        ...
        await browser.pause(1000)
        await $(await GamePage.stopMatchBtn).click()
        await GamePage.makeFoul(game.home, game.home, game.inBox, game.coach, null, 0, game.miss, game.player, game.coachDisqualifying, 'no substitution')
        await browser.pause(1000)
        ...
        await $(await GamePage.editCheckedStartTimePencil).click()
        await browser.pause(1000)
        await GamePage.endPeriod('down', 10)
