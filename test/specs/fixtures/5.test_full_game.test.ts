...
describe('TEST game', () => {
    ...
    it('This test should populate full game', async () => {
        ...
        await GamePage.checkTimeoutBtns(await $(GamePage.gameTimeoutBtn), await $(GamePage.gameOfficialTimeout), await $(GamePage.gameCommercialTimeout), 'Commercial', await $(GamePage.bloodRuleCheckbox), await $(GamePage.gameMandatoryCheckbox), await $(GamePage.gameTimeoutOkBtn))
