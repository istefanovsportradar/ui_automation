...
describe('Full game', () => {
    ...
    it('This test should populate full game', async () => {
        ...
        await GamePage.miss2Points(game.home, game.outBox, game.hookShot, 'null', 'null', game.block, game.away, game.player, 'null')
        await GamePage.miss2Points(game.away, game.outBox, game.hookShot, 'null', 'null', 'null', 'null', 'null', game.shotClockValidation)
        await GamePage.miss3Points(game.home, game.stepBackJumpShot, 'null', 'null', game.block, game.away, game.player, 'null')
        await GamePage.miss3Points(game.away, game.stepBackJumpShot, 'null', 'null', 'null', 'null', 'null', game.shotClockValidation)

        await GamePage.made2Points(game.home, game.inBox, game.jumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakTrue, game.defensiveTrue, null)
        await GamePage.makeTurnover(game.away, game.player, turnover.badPass, turnover.stealPlayer)
        await GamePage.made2Points(game.home, game.inBox, game.turnAroundJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakTrue, game.defensiveTrue, null)
        await GamePage.makeTurnover(game.away, game.player, turnover.ballHandling, turnover.stealPlayer)
        await GamePage.made3Points(game.home, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveTrue, null)
        await GamePage.makeTurnover(game.away, game.player, turnover.badPass, turnover.stealPlayer)

        //<--- MADE 2 POINTS -->
        await GamePage.makeTurnover(game.home, game.player, turnover.badPass, turnover.stealPlayer)
        await GamePage.made2Points(game.away, game.inBox, game.layup, game.made, game.assist, game.foulOnShotFalse, game.fastBreakTrue, game.defensiveTrue, null)
        ...
        await GamePage.made2Points(game.home, game.inBox, game.hookShot, game.miss, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.offensiveTrue, game.tipinMiss)
        await GamePage.made2Points(game.home, game.outBox, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveTrue, null)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        ...
        await GamePage.made2Points(game.home, game.inBox, game.fadeAwayJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakTrue, game.defensiveFalse, null)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        //await expect(teamScoreResult[0]).toEqual("6")
        //await expect(teamScoreResult[1]).toEqual("4")

        await GamePage.made2Points(game.away, game.inBox, game.floatingJumpShot, game.made, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveFalse, null)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        //await expect(teamScoreResult[0]).toEqual("6")
        //await expect(teamScoreResult[1]).toEqual("7")

        await GamePage.made2Points(game.home, game.inBox, game.pullUpJumpShot, game.made, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveTrue, null)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        //await expect(teamScoreResult[0]).toEqual("9")
        //await expect(teamScoreResult[1]).toEqual("7")

        await GamePage.made2Points(game.away, game.inBox, game.stepBackJumpShot, game.made, game.assist, game.foulOnShotTrue, game.fastBreakFalse, game.defensiveFalse, null)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        //await expect(teamScoreResult[0]).toEqual("9")
        //await expect(teamScoreResult[1]).toEqual("10")

        await GamePage.made2Points(game.home, game.inBox, game.turnAroundJumpShot, game.made, game.assist, game.foulOnShotTrue, game.fastBreakFalse, game.defensiveFalse, null)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        //await expect(teamScoreResult[0]).toEqual("12")
        //await expect(teamScoreResult[1]).toEqual("10")

        await GamePage.made2Points(game.away, game.inBox, game.drivingLayup, game.miss, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveTrue, game.tipinMade)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        //await expect(teamScoreResult[0]).toEqual("12")
        //await expect(teamScoreResult[1]).toEqual("14")

        await GamePage.made2Points(game.home, game.outBox, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveTrue, null)
        await GamePage.made2Points(game.away, game.inBox, game.hookShot, game.miss, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveTrue, game.tipinMiss)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        ...
        await GamePage.made2Points(game.away, game.inBox, game.alleyOop, game.miss, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveTrue, game.tipinMadeFauled)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        //await expect(teamScoreResult[0]).toEqual("19")
        //await expect(teamScoreResult[1]).toEqual("18")

        await GamePage.made2Points(game.away, game.inBox, game.dunk, game.made, game.assist, game.foulOnShotFalse, game.fastBreakTrue, game.defensiveTrue, game.noFollowOn)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        //await expect(teamScoreResult[0]).toEqual("19")
        ...
        //<--- MADE 3 POINTS --->
        await GamePage.made3Points(game.away, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveTrue, null)
        await GamePage.makeTurnover(game.home, turnover.teamTurnover, turnover.second8Violation, turnover.noSteal)
        await GamePage.made3Points(game.away, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveTrue, null)

        await GamePage.made3Points(game.home, game.fadeAwayJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakTrue, game.defensiveFalse, null)

        await GamePage.makeTurnover(game.away, turnover.teamTurnover, turnover.second8Violation, turnover.noSteal)
        await GamePage.made3Points(game.home, game.fadeAwayJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakTrue, game.defensiveFalse, null)

        await GamePage.made3Points(game.away, game.floatingJumpShot, game.made, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveFalse, null)

        await GamePage.made3Points(game.home, game.pullUpJumpShot, game.made, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveTrue, null)

        await GamePage.made3Points(game.away, game.stepBackJumpShot, game.made, game.assist, game.foulOnShotTrue, game.fastBreakFalse, game.defensiveFalse, null)

        await GamePage.made3Points(game.home, game.turnAroundJumpShot, game.made, game.assist, game.foulOnShotTrue, game.fastBreakFalse, game.defensiveFalse, null)

        await GamePage.made3Points(game.away, game.jumpShot, game.miss, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveTrue, game.tipinMiss)

        await GamePage.made3Points(game.away, game.fadeAwayJumpShot, game.made, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveFalse, null)

        await GamePage.made3Points(game.home, game.fadeAwayJumpShot, game.miss, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveTrue, game.tipinMade)

        await GamePage.made3Points(game.away, game.floatingJumpShot, game.miss, game.assist, game.foulOnShotTrue, game.fastBreakTrue, game.defensiveTrue, game.tipinMadeFauled)

        await GamePage.made3Points(game.away, game.pullUpJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakTrue, game.defensiveTrue, game.noFollowOn)
        //teamScoreResult = await HelperPage.returnArrayElementsTextFunction(await GamePage.teamScoreResult)
        ...
        await GamePage.made2Points(game.home, game.outBox, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveFalse, null)
        ...
        await GamePage.miss2Points(game.away, game.outBox, game.floatingJumpShot, game.home, 'null', 'null', 'null', 'null', 'null')

        await GamePage.made2Points(game.home, game.outBox, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveTrue, null)

        await GamePage.miss2Points(game.away, game.outBox, game.floatingJumpShot, game.home, 'null', 'null', 'null', 'null', 'null')

        await GamePage.miss2Points(game.home, game.outBox, game.dunk, 'null', game.away, 'null', 'null', 'null', 'null')

        await GamePage.made3Points(game.away, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveTrue, null)

        await GamePage.miss2Points(game.home, game.outBox, game.hookShot, 'null', 'null', game.block, game.away, game.player, 'null')

        await GamePage.made2Points(game.away, game.inBox, game.stepBackJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveFalse, null)
        await GamePage.miss3Points(game.home, game.pullUpJumpShot, game.away, 'null', 'null', 'null', 'null', 'null')
        await GamePage.miss3Points(game.away, game.pullUpJumpShot, game.home, 'null', 'null', 'null', 'null', 'null')

        await GamePage.made2Points(game.home, game.inBox, game.fadeAwayJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveFalse, null)

        await GamePage.made3Points(game.away, game.stepBackJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveFalse, null)

        await GamePage.miss3Points(game.home, game.fadeAwayJumpShot, 'null', game.away, 'null', 'null', 'null', 'null')
        await GamePage.miss3Points(game.away, game.fadeAwayJumpShot, 'null', game.home, 'null', 'null', 'null', 'null')

        await GamePage.made2Points(game.home, game.inBox, game.fadeAwayJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveFalse, null)

        await GamePage.made3Points(game.away, game.stepBackJumpShot, game.made, game.assist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveFalse, null)
        await GamePage.miss3Points(game.home, game.stepBackJumpShot, 'null', 'null', game.block, game.away, game.player, 'null')
        await GamePage.miss3Points(game.away, game.stepBackJumpShot, 'null', 'null', game.block, game.home, game.player, 'null')
        ...
        await GamePage.made3Points(game.away, game.jumpShot, game.made, game.noAssist, game.foulOnShotFalse, game.fastBreakFalse, game.defensiveFalse, null)
        ...
        await GamePage.makeFoul(game.home, game.home, game.inBox, game.player, game.offensiveFoul, 0, game.made, game.noPlayer, null)
        await GamePage.makeFoul(game.away, game.home, game.outBox, game.player, game.technicalFoul, 1, game.made, game.player, null)
        await GamePage.makeFoul(game.away, game.away, game.inBox, game.coach, null, 1, game.made, game.player, game.coachDisqualifying)
        await GamePage.makeFoul(game.home, game.home, game.inBox, game.player, game.unsportsmanlike, 2, game.miss, game.noPlayer, null)
        await GamePage.makeFoul(game.home, game.away, game.outBox, game.player, game.doubleFoul, 3, game.miss, game.noPlayer, null)
        await GamePage.makeFoul(game.home, game.home, game.inBox, game.player, game.disqualifying, 2, game.made, game.player, null)
        await GamePage.makeFoul(game.away, game.home, game.outBox, game.player, game.personalFoul, 1, game.made, game.player, null)
        await browser.pause(1000)

        await GamePage.makeFoul(game.home, game.home, game.inBox, game.bench, null, 0, game.made, null, null)
        await GamePage.makeFoul(game.away, game.home, game.outBox, game.bench, null, 1, game.miss, null, null)
        await GamePage.makeFoul(game.away, game.home, game.inBox, game.bench, null, 2, game.made, null, null)
        await GamePage.makeFoul(game.away, game.home, game.outBox, game.bench, null, 3, game.miss, null, null)
        await browser.pause(1000)

        await GamePage.makeFoul(game.home, game.home, game.inBox, game.coach, null, 0, game.miss, game.player, game.coachTechnical)
        await GamePage.makeFoul(game.away, game.home, game.outBox, game.coach, null, 1, game.made, game.player, game.coachTechnical)
        await GamePage.makeFoul(game.away, game.home, game.inBox, game.coach, null, 2, game.made, game.player, game.coachTechnical)
        await GamePage.makeFoul(game.away, game.home, game.outBox, game.coach, null, 3, game.miss, game.player, game.coachTechnical)
        await browser.pause(1000)

        await GamePage.makeFoul(game.away, game.home, game.inBox, game.coach, null, 0, game.miss, game.player, game.coachDisqualifying)
        await GamePage.makeFoul(game.away, game.home, game.outBox, game.coach, null, 1, game.made, game.noPlayer, game.coachDisqualifying)
        await GamePage.makeFoul(game.away, game.home, game.inBox, game.coach, null, 2, game.made, game.player, game.coachDisqualifying)
        await GamePage.makeFoul(game.away, game.home, game.outBox, game.coach, null, 3, game.miss, game.player, game.coachDisqualifying)
        await browser.pause(1000)
